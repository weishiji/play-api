...
alter table product add constraint fk_product_product_id foreign key (product_id) references product_to_category (category_id) on delete restrict on update restrict;
...
alter table product drop foreign key fk_product_product_id;
